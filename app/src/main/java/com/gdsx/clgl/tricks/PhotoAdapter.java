...
import com.gdsx.clgl.view.MainActivity;
import com.gdsx.clgl.view.TakePhotoActivity;
        ...
        holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //intent.putExtra(PhotoPagerActivity.EXTRA_SHOW_DELETE, true);
                    if (mContext instanceof TakePhotoActivity) {
                    ((TakePhotoActivity) mContext).previewPhoto(intent);
                }
            }
        });
