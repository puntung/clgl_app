 ...
 */
public class UploadedPicAdapter extends RecyclerView.Adapter {
    ...
    public UploadedPicAdapter(Context context) {
        this.context = context;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_already_upload,parent,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((ViewHolder) holder).tiptxt.setText("已上传");
        ((ViewHolder) holder).timetxt.setText(ur.getUploadtime());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            diagram = (ImageView)itemView.findViewById(R.id.item_pic);
            tiptxt = (TextView)itemView.findViewById(R.id.item_tiptxt);
